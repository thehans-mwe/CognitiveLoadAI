...
# Maximum text length (~50,000 chars / ~10,000 words)
    ...
    def do_POST(self):
        try:
            ...
            if content_length > MAX_TEXT_LENGTH * 2:
                self._send_json(413, {'error': 'Request body too large. Max ~50,000 characters.', 'code': 'BODY_TOO_LARGE'})
                return
            ...
            try:
                ...
                self._send_json(400, {'error': 'Invalid JSON in request body', 'code': 'INVALID_JSON'})
                return
            ...
            if not text:
                self._send_json(400, {'error': 'Please provide text in the "text" field', 'code': 'MISSING_TEXT'})
                return
